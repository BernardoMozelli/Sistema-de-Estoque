...
def valida_entradaestoque():
    from menu_paginas.cadastro_produto import var_validaseg, var_fabri, var_fornec, var_nomevalida, var_validamodelo, var_validadata, var_condicao, var_validaquantidade, var_validavalor
    ...
    #valida as entrys
    while (var_nomevalida or var_validamodelo or var_validadata or var_condicao or var_validaquantidade or var_validavalor) == None:
        msgErroEntradaestoque()
