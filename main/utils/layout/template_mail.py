...
<!DOCTYPE html>
    ...
    <body bgcolor="#242424" style="width: 100%; font-family:Lato, sans-serif; font-size:14px;">       
         
        <div align="center">
            <img align="center" border="0" src="cid:background_image" " alt="banner_redefinir" style="display:block; padding:15px 20px 10px; height: "370"; width: 100%; max-width: 800px;" width="800"/>
            <br/>
            <br/>
        </div>
