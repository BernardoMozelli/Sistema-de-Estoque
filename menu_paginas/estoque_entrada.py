...
from banco_conections.conexao_entradaestoque import var_resultfabricante, var_resultfornecedor, var_resulEsegmento
...
def entrada_estoque():
    ...
    combobox_fabricante = customtkinter.CTkOptionMenu(master=janela_entrada,
                                       values=selected_fabricante,
                                       width=350, height=30,
                                       dynamic_resizing=False,
                                       fg_color=co0,
                                       bg_color=co0)
    combobox_fabricante.place(x=759, y=198, anchor=tkinter.CENTER)
    ...
    combobox_fornecedor = customtkinter.CTkOptionMenu(master=janela_entrada,
                                       values=selected_fornecedor,
                                       dynamic_resizing=False,
                                       fg_color=co0,
                                       bg_color=co0)
    combobox_fornecedor.configure(width=350, height=30)
    combobox_fornecedor.place(x=759, y=274, anchor=tkinter.CENTER)
    # -----------------------------------------------------------------
